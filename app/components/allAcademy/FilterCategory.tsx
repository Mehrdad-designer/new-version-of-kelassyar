// components/institutes/FilterCategory.tsx
"use client";
        ...
        {displayedCategories.map((category) => (
          ...
          >
            <div className="relative">
              ...
              />
              <div className="w-5 h-5 border-2 border-gray-300 rounded-md peer-checked:bg-blue-500 peer-checked:border-blue-500 transition-all flex items-center justify-center">
                <i className="fas fa-check text-white text-xs opacity-0 peer-checked:opacity-100"></i>
              </div>
            </div>
            <div className="flex items-center gap-2 flex-1">
              <i
                className={`fas ${category.icon} text-gray-400 group-hover:text-blue-500 transition-colors`}
              ></i>
