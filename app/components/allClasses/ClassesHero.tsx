...
export default function ClassesHero({ stats }: ClassesHeroProps) {
    return (
        <section style={{height:'800px'}} className="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 py-20">
            {/* Background Elements */}
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute top-32 right-[15%] w-14 h-14 bg-white/10 backdrop-blur-sm rounded-2xl flex items-center justify-center animate-float" style={{ animationDelay: '1s' }}>
                    <i className="fas fa-chalkboard-teacher text-white/80 text-xl"></i>
                </div>
                <div className="absolute bottom-24 left-[20%] w-12 h-12 bg-white/10 backdrop-blur-sm rounded-xl flex items-center justify-center animate-float" style={{ animationDelay: '2s' }}>
                    <i className="fas fa-graduation-cap text-white/80 text-lg"></i>
                </div>
                <div className="absolute bottom-32 right-[25%] w-14 h-14 bg-white/10 backdrop-blur-sm rounded-2xl flex items-center justify-center animate-float" style={{ animationDelay: '0.5s' }}>
            ...
            <div className="relative container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-lg md:text-xl text-purple-100 mb-10 leading-relaxed max-w-2xl mx-auto">
                        دسترسی به هزاران کلاس آموزشی در حوزه‌های مختلف با بهترین اساتید و امکان ثبت‌نام آنلاین
                    </p>
